...
# ───────── 主函数 ─────────
def main():
    data_dir="/Volumes/T7/WSI/features/melting/NO_Aug/train"
    out_dir ="/Volumes/T7/WSI/features/melting/NO_Aug/train/pth";os.makedirs(out_dir,exist_ok=True)
    bs,epochs,lr,wd = 128,500,1e-5,1
