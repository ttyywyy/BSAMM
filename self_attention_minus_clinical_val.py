...
model_path    = "/Volumes/T7/WSI/features/melting/train/pth/best_overall_clinical.pth"
path_risk     = "/Volumes/T7/WSI/features/melting/train/risk_out_train-clinical.xlsx"
# ==========================================================
...
def main():
    ...
    ds_test = MultimodalDataset(mri, wsi, ich, surv)
    ...
    with torch.no_grad():
        for mri_b,  wsi_b, ich_b, t_b, e_b in dl_test:
            mri_b = mri_b.to(device); wsi_b = wsi_b.to(device); ich_b = ich_b.to(device)
            r= model(mri_b, wsi_b, ich_b)
