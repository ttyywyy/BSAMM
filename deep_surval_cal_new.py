...
input = '/Volumes/T7/WSI/features/melting/FC/test/all_features.csv'
PFS = '/Volumes/T7/WSI/features/melting/FC/test/PFS_survival.csv'
...
# ───────────── 5. 训练 & 验证循环 ─────────────
def test_deepsurv(x_csv: str, y_csv: str):
    ...
    for x,t,e in test_loader:
        ...
        c_index_test = concordance_index(t.numpy(), -risk.numpy(), e.numpy())
        print(loss,c_index_test)

if __name__ == "__main__":


    test_deepsurv(input,PFS)