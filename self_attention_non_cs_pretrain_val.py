...
import sys
# ===== 路径自行替换 =====
data_dir_test = "/Volumes/T7/WSI/features/test_new"
model_path    = "/Volumes/T7/WSI/features/train_new6/pretrained/select1/best_overall_pretrained.pth"
path_risk     = "/Volumes/T7/WSI/features/test_new/risk_out.xlsx"
path_feat64   = "/Volumes/T7/WSI/features/test_new/features64.xlsx"
# ==========================================================
...
def main():
    ...
    wsi  = pd.read_excel(os.path.join(data_dir_test, "zd_wsi_features.xlsx"), index_col=0)
    ich = pd.read_excel(os.path.join(data_dir_test, "zd_ich_features.xlsx"), index_col=0)
    text = pd.read_excel(os.path.join(data_dir_test, "zd_clinical_features.xlsx"),index_col=0)
    surv = pd.read_excel(os.path.join(data_dir_test, "zd_PFS_survival_revised.xlsx"), index_col=0)
